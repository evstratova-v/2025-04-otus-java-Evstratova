...
public class DbServiceDemo {
    ...
    public static void main(String[] args) {
        ...
        var clientSecond = dbServiceClient.saveClient(new Client(
                "dbServiceSecond",
                new Address("SecondStreet"),
                List.of(new Phone("15-777-44"), new Phone("16-888-555"))));
        ...
        dbServiceClient.saveClient(new Client(
                ...
                new Address("SecondStreetUpdate"),
                List.of(new Phone("17-999-66"), new Phone("18-000-777"))));
